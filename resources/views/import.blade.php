...
<form method="POST" action="{{ route('submit-form') }}" class="import-form">
    @csrf
    <input type="text" placeholder="bookName" name="bookName" class="form-inputs"><br>
    <input type="text" placeholder="url" name="url" class="form-inputs"><br>
    <input type="text" placeholder="title formatted" name="title_formatted" class="form-inputs"><br>
